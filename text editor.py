...
def about():
    showinfo("About this program", "This is a program written by the Great Web Developer. Yup! that's him!!!")
...
file_manu = Menu(menu_bar, tearoff=0)
...
file_manu.add_command(label="Exit", command=quit)
